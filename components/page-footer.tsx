...
export const PageFooter = () => {
	return (
		<footer className="bg-very-dark-violet w-full">
	...
	return (
		<>
			{data.map((item) => (
				<li
					key={item}
					className="relative items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2  no-underline hover:opacity-80 active:opacity-disabled transition-opacity text-default-400">
					{item}
				</li>
			))}
		</>
